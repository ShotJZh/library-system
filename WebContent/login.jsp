...
<div id="login-reg">
	...
	<div class="login-reg-box">
		<div class="login-reg-button">
			...
			<a href="javascript:;" id='click2' class="bounceIn">注册</a>				
		</div>
		...
		<div id="dialog1" class="animated">
			...
			<form action="" method="post" id="editForm">
				<ul class="editInfos">
					<li><label><font color="#ff0000">* </font>用户名：<input type="text" name="" value="" class="ipt" /></label></li>
					<li><label><font color="#ff0000">* </font>密码：<input type="text" name="" value="" class="ipt" /></label></li>					
